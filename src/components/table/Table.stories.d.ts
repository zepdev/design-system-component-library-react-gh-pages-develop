...
declare const meta: {
    title: string;
    component: {
        ({ children, className, variant, maxWidth, maxHeight, fullWidth, textTop, buttonLabel, descriptionBottom, descriptionTop, rows, columnNames, align, tableButtonOnClick, iconButtonOnClick, ...props }: import("./table.interface").TableProps): import("react/jsx-dev-runtime").JSX.Element;
        Body: ({ children, ...props }: import("./table.interface").TableBodyProps) => import("react/jsx-dev-runtime").JSX.Element;
        Cell: ({ children, className, isFirstRow, align, ...props }: import("./table.interface").TableCellProps) => import("react/jsx-dev-runtime").JSX.Element;
